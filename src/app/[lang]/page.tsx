      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {[
            ...
            },
            {
              icon: (
                <svg className="w-12 h-12 text-brand-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 13h10M7 17h10" />
                </svg>
              ),
              ...t.features.blog,
            ...
            >
              <div className="mb-8 group-hover:scale-110 transition-transform duration-500 w-fit">{feature.icon}</div>
              <h3 className="text-2xl font-black text-gray-900 mb-4 group-hover:text-brand-600 transition-colors uppercase tracking-tight font-heading">
                {feature.title}
              </h3>
